...
public class LeiloesPage extends PageObject {
    ...
    public CadastroLeilaoPage carregarFormulario() {
        this.driver.navigate().to(URL_FORM);
    ...
    public boolean isLeilaoCadastrado(String nome, String valorInicial, String dataAbertura) {
        ...
        return colunaNome.getText().equals(nome) && colunaDataAbertura.getText().equals(dataAbertura)
                && colunaValorInicial.getText().equals(valorInicial);
    }

    public boolean isPaginaAtual() {
        return this.driver.getCurrentUrl().equals(URL_LIST);
    }
